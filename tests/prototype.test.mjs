...
assert.match(html, /data-record-overview/, "record home should expose an app-style overview");
assert.match(html, /data-record-latest-title/, "record overview should expose the latest memory title");
assert.match(html, /data-record-latest-meta/, "record overview should expose latest memory metadata");
assert.match(html, /data-record-visibility/, "record overview should expose archive visibility mix");
assert.match(html, /data-record-next-action/, "record overview should expose the next useful action");
